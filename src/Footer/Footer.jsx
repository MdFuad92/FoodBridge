...
const Footer = () => {
    return (
      ...
      <footer className="  bg-gray-900 w-full z dark:bg-neutral-950 hero md:min-h-96  " style={{backgroundImage: 'url(https://i.ibb.co/s2sz9tr/crop-plate-with-vegetable-salad.jpg'}} >
        <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">

          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            <div className="col-span-full lg:col-span-1">
            <BiSolidDonateHeart className="text-7xl text-white" />
              <a className="flex-none text-xl font-semibold text-white font-pacifico" href="#" aria-label="Brand">Food Bridge </a>
            </div>
            ...
            <div className="col-span-1">
              ...
              <div className="mt-3 grid space-y-3">
                ...
                <p><a className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Careers</a> <span className="inline ms-1 text-xs bg-green-700 text-white py-1 px-2 rounded-lg">We are hiring</span></p>
            ...
            <div className="col-span-2">
              ...
              <form>
                <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2 dark:bg-neutral-900">
                  ...
                  <a className="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-green-600 text-white  disabled:opacity-50 disabled:pointer-events-none" href="#">
                    Subscribe
                  </a>
                </div>
          ...
          <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
            <div className="flex justify-between items-center">
              <p className="text-sm text-gray-400 dark:text-neutral-400">© 2024 FoodBridge. All rights reserved.</p>
            </div>
