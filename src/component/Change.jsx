...
<form onSubmit={handleUpdate} className="card-body     " data-aos="fade-up"data-aos-duration='1000'>
  ...
  <div className='md:flex items-center gap-8'>
      ...
      <input type="text" name='Food_name' defaultValue={food_name} placeholder="Food Name" className="input input-bordered" required />
      ...
      <input  type="text" placeholder="Food URL" defaultValue={image} name='Food_image' className="input input-bordered w-full" required />
      </div>
  ...
  <span className="label-text text-black text-sm">Pickup Location</span>
      ...
      <select className='input border-gray-200' defaultValue={location} placeholder='Pickup Location'  type="text" name="pickup_location" id="location">
      ...
      <input type="date" name='date' defaultValue={date} placeholder="Expiration Date" className="input input-bordered" required />
  ...
  <div className="form-control md:w-1/2 ">
      ...
      <select className='input border border-gray-200' defaultValue={quantity} placeholder='Category'  type="text" name="quantity" id="quantity-type">
      ...
      <input  type="radio" name='status' value='Available' defaultValue={status} checked   className="checkbox checkbox-success" required  />
      ...
      <input  type="radio" name='status' value='Not Available' defaultValue={status}   className="checkbox checkbox-error" required  />
  ...
  <div className="form-control">
    ...
    <input type="photo" placeholder="photo" name='photo' defaultValue={photo} className="input input-bordered" required readOnly />
  </div>
  <div className="form-control md:w-1/2 ">
      <label className="label">
  ...
  <div className="form-control w-full ">
      ...
      <input type="text" name='note' defaultValue={note} placeholder="Note" className="input input-bordered" required />
      </div>
